...
// Use extern "C" to link the shader byte arrays generated by xxd.
extern "C" {
...
// A map to associate shader names with their embedded data
static const std::map<std::string, std::pair<const unsigned char *, unsigned int>>
    shaderData = {{"core.vert", {spirv_core_vert, spirv_core_vert_len}},
                  {"core.frag", {spirv_core_frag, spirv_core_frag_len}}};

VPipeline::VPipeline(VDevice &device, const std::string &vertShaderName,
...
void VPipeline::createGraphicsPipeline(const std::string &vertShaderName,
                                     const std::string &fragShaderName,
                                     VkRenderPass renderPass) {

    if (shaderData.find(vertShaderName) == shaderData.end() ||
        shaderData.find(fragShaderName) == shaderData.end()) {
        throw std::runtime_error("Could not find shader: " + vertShaderName +
                                 " or " + fragShaderName);
    }
    ...
    pushConstantRange.size = sizeof(Primitives::Triangle);
